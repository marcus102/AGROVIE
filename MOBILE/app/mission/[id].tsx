    ...
    const fetchMission = async () => {
      if (id) {
        ...
        if (!loading && !error && fetchedMission) {
          ...
          // If user is the mission owner, fetch employees
    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.content}>
            ...
            <Section title="Progression de la mission">
              <View style={styles.progressContainer}>
                ...
                <View style={styles.timeLeftContainer}>
                  ...
                  <Text style={[styles.timeLeftText, { color: colors.muted }]}>
                    {calculateTimeLeft()} jours restants
                  </Text>
                </View>
              </View>
            </Section>
          ...
          {isOwner && employees.length > 0 && (
            <Section title={`Employés (${employees.length})`}>
